...
const NovoProprietarioView = ({ adicionarProprietario, cancelar, proprietarioService }) => {
        ...
        <View style={styles.itemContainer}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-around', padding: 15, alignItems: 'center', flex:1 }}>
                ...
                <View style={{ flexDirection: 'row' }}>
                    ...
                    <Pressable onPress={() => {
                        adicionarProprietario(nome, proprietarioService);
                        setNome('');
                    }}>
